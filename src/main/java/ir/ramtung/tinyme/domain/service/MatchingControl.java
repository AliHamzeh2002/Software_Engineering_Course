...
public interface MatchingControl {
    default MatchingOutcome canStartExecution(Order order) { return MatchingOutcome.APPROVED; }
    ...
    default void tradeAccepted(Order newOrder, Order matchingOrder, Trade trade) {}
